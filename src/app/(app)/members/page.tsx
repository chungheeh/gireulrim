...
export default async function MembersPage() {
  ...
  const { data: members } = await supabase
    .from("users")
    .select("id, name, instruments, preferred_genre, vocal_range, favorite_artist, signature_song, bio, can_give_lesson, age, location, available_days, role, profile_image_url")
    .order("name");
